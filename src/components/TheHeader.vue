        ...
        <div class="header__nav">
          ...
          <ul class="header__nav-navbar">
            <li class="navbar__item">
              <router-link to="/" class="navbar__item-heading"
                >home</router-link
              >
            </li>
            <li class="navbar__item">
              <router-link :to="{ name: 'foods' }" class="navbar__item-heading"
                >shop</router-link
              >
            </li>
            <li class="navbar__item">
              <a href="#" class="navbar__item-heading">Services</a>
            </li>
            <li class="navbar__item">
              <router-link :to="{ name: 'about' }" class="navbar__item-heading"
